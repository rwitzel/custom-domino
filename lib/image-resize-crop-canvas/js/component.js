...
var resizeableImage = function(image_target) {
  ...
  crop = function(){
    ...
    var crop_url = crop_canvas.toDataURL("image/png")
    if (typeof domino_symbol == "undefined") {
        window.open(crop_url);
    }
    else {
        var upload_divs = document.querySelectorAll(".upload_div");
        upload_divs[domino_symbol].querySelector(".thumb").src = crop_url;
        updateDominoes();
